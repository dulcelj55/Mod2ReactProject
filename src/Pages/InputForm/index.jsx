   ...
   const returnInputsOrTexts =()=>{
          if (!isSubmitted){
              ...
              <form onSubmit={showInfo}>
                  ...
                  <input value={userAge}  onChange={(e)=> setUserAge(e.target.value)} placeholder= 'User Age'></input>
                  <input value={userGender} onChange={(e)=> setUserGender(e.target.value)} placeholder='UserGender'></input>
